...
def suma_cubo_pares_for(numeros: Iterable[int]) -> int:
    ...
    for n in numeros:
        c=n**3
        numeros_cubo.append(c)
    for n in numeros_cubo:
        if n%2==0:
            suma=suma+n
    return suma
...
numeros_al_cubo = (lambda num:[n**3 for n in num  ])(numeros)


# Escribir una función lambda que permita filtrar todos los elementos pares

numeros_al_cubo_pares = (lambda num:[n**3 for n in num if n%2==0])(numeros)
...
suma_numeros_al_cubo_pares = (lambda num:reduce(lambda a,b:a+b,num))(numeros_al_cubo_pares)


# Escribir una función Lambda que permita ordenar los elementos de la numeros
# en base a si son pares o impares

numeros_ordenada = (lambda num:[n for n in num if n%2!=0]+[n for n in num if n%2==0])(numeros)
